...
/***********************************************************************
/*	＜総合文化展＞	ra_pem_list.php
/*	
/*		概  要：ギャラリー：らくらくエントリーの部
/*
/*		備  考：なし
/*
...
function Func_Load_SettingFrame($prm_indent, $prm_group, $prm_array, $prm_dsp, $prm_mod) {
	...
	$rtn_value .= Func_Con_Write($prm_indent, "		<td rowspan=\"3\" colspan=\"1\">"												);
	...
	$rtn_value .= Func_Con_Write($prm_indent, "							<div class=\"w240 h20 mb5 pt3 pl5 pb3 pr5 word_break\">"	);
	...
	$rtn_value .= Func_Con_Write($prm_indent, "		</td>"																			);
	$rtn_value .= Func_Con_Write($prm_indent, "	</tr>"																				);
	$rtn_value .= Func_Con_Write($prm_indent, "	<tr><td rowspan=\"1\" colspan=\"1\"><hr></td></tr>"									);
	$rtn_value .= Func_Con_Write($prm_indent, "	<tr>"																				);
	$rtn_value .= Func_Con_Write($prm_indent, "		<td rowspan=\"1\" colspan=\"1\">"												);
	$rtn_value .= Func_Con_Write($prm_indent, "			<div class=\"pt0 pr10 pb5 pl0\">"											);
	$rtn_value .= Func_Con_Write($prm_indent, "				<table class=\"det_tbl\">"												);
	$rtn_value .= Func_Con_Write($prm_indent, "					<tr>"																);
	$rtn_value .= Func_Con_Write($prm_indent, "						<th class=\"textLeft\">"										);
	...
	$rtn_value .= Func_Con_Write($prm_indent, "					<tr>"																);
	$rtn_value .= Func_Con_Write($prm_indent, "						<td class=\"textLeft\">"										);
	$rtn_value .= Func_Con_Write($prm_indent, "							<div class=\"w240 h110 mb5 pt3 pl5 pb3 pr5 word_break\">"	);
