            ...
            <fieldset class="m10 pl20 pr20">
                ...
                <dl>
                    ...
                    <dd class=" ">
                        <ul class="  helpInfo">
                            <li>
                                画面上部のエントリー部門「<img src="./images/help/h0_m_ri.png" align="middle" border="1"
                                                  class="ml5 mr5" alt="力作じまんの部">」「<img src="./images/help/h0_m_ra.png"
                                                                                       align="middle" border="1"
                                                                                       class="ml5 mr5"
                                                                                       alt="らくらくエントリーの部">」を選択すると、それぞれのカテゴリーが表示されます。<br>
                                <div class="m10 ">
                    ...
                    <dd class=" ">
                        <ul class="helpInfo">
                            ...
                            <li>
                                各カテゴリーの応募作品をご覧いただき、最も気に入った作品の「<img src="./images/help/h1_v_b1.png" align="middle"
                                                                   class="ml5 mr5" alt="投票する">」ボタンをクリックしてください。<br>
                                <div class=" pt10 pb10">
                                    <img class="img-fluid" src="./images/help/h1_vote.png" align="middle" alt="投票方法">
                                </div>
                                <img src="./images/help/h1_v_b1.png" class="img-fluid" align="middle" class="ml5 mr5"
                                     alt="投票する">」ボタンをクリックすると、ボタンが「<img src="./images/help/h1_v_b2.png" align="middle"
                                                                       class="ml5 mr5" alt="選択済">」に変わります。<br>
                                <img src="./images/help/h1_v_b2.png" class="img-fluid" align="middle" class="ml5 mr5"
                                     alt="選択済">」ボタンを再度クリックすると、投票選択が解除されます。<br>
                    ...
                    <dd class=" ">
                        <ul class="  helpInfo">
                            <li>
                                画面上部の「<img src="./images/help/h2_m_rk.png" align="middle" border="1" class="ml5 mr5"
                                           alt="投票ランキング">」をクリックすると、各カテゴリーの上位５作品を確認できます。
                                <div class="  ">
