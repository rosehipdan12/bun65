	...
	<ul class="navimenu" id="topNavBar" >
			...
			<li class="nv_tab kids">
				<dl>
					...
					<dd class="nv_hid" style="display: none;">
						<ul>
							<li class="nv_pan"><a href="javascript:void(0);" class="an_anc" onclick="SET_PAGE(&#39;SET_RI&#39;, &#39;LS_P01&#39;);">絵</a></li>
							<li class="nv_pan"><a href="javascript:void(0);" class="an_anc" onclick="SET_PAGE(&#39;SET_RI&#39;, &#39;LS_P02&#39;);">書道</a></li>
						</ul>
					</dd>
				</dl>
			...
			<li class="nv_tab enj">
				<dl>`エンジョイ部門`
					<dt class="nv_ttl"><a href="javascript:void(0);" class="an_tab"></a></dt>
					<dd class="nv_hid" style="display: none;">
						<ul>
							<li class="nv_pan"><a href="javascript:void(0);" class="an_anc" onclick="SET_PAGE(&#39;SET_RI&#39;, &#39;LS_P01&#39;);">写真</a></li>
							<li class="nv_pan"><a href="javascript:void(0);" class="an_anc" onclick="SET_PAGE(&#39;SET_RI&#39;, &#39;LS_P02&#39;);">絵画</a></li>
							<li class="nv_pan"><a href="javascript:void(0);" class="an_anc" onclick="SET_PAGE(&#39;SET_RI&#39;, &#39;LS_P01&#39;);">音楽</a></li>
							<li class="nv_pan"><a href="javascript:void(0);" class="an_anc" onclick="SET_PAGE(&#39;SET_RI&#39;, &#39;LS_P01&#39;);">動画</a></li>
						</ul>
					</dd>
				</dl>
			</li>
